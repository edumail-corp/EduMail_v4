...
export function getLocalizedWorkspaceIntegrationStatuses(
  ...
  > = {
    database: {
      label: "Baza danych",
      summary:
        "Skrzynka, aktywność i metadane dokumentów są obecnie zapisywane w lokalnych plikach JSON.",
      nextStep:
        "Wybierz hostowaną lub własną bazę danych i dostarcz dane połączenia.",
    },
    auth: {
    ...
    "file-storage": {
      ...
      summary:
        "Dokumenty bazy wiedzy są teraz przechowywane lokalnie w projekcie.",
      nextStep:
        "Wybierz produkcyjne przechowywanie plików dla dokumentów i retencji.",
    },
    "ai-provider": {
...
export function getLocalizedWorkspaceFutureDomainModel(
  ...
  > = {
    ...
    documents: {
      ...
      description:
        "Metadane referencyjne, zapisane pliki, kategorie, podglądy i relacje cytowań.",
    },
    activity: {
